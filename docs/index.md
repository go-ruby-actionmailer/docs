# go-ruby-actionmailer documentation

**Pure-Go, MRI-4.0.5-faithful Ruby actionmailer (no cgo)**

`go-ruby-actionmailer/actionmailer` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `actionmailer`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `actionmailer`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`actionmailer`](https://github.com/go-ruby-actionmailer/actionmailer) | the library — Ruby's `actionmailer` in pure Go |
| [`docs`](https://github.com/go-ruby-actionmailer/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-actionmailer.github.io`](https://github.com/go-ruby-actionmailer/go-ruby-actionmailer.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-actionmailer/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-actionmailer/actionmailer](https://github.com/go-ruby-actionmailer/actionmailer).
