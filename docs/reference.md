...
The public API lives at the module root (`github.com/go-ruby-actionmailer/actionmailer`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `actionmailer`, while the surface follows
...
```go
import "github.com/go-ruby-actionmailer/actionmailer"
```
...
- **[pkg.go.dev/github.com/go-ruby-actionmailer/actionmailer](https://pkg.go.dev/github.com/go-ruby-actionmailer/actionmailer)**

The module's [README](https://github.com/go-ruby-actionmailer/actionmailer#readme) carries worked
