...
Contributions are welcome. `go-ruby-actionmailer/actionmailer` is built to a small set of
...
The library is in [`github.com/go-ruby-actionmailer/actionmailer`](https://github.com/go-ruby-actionmailer/actionmailer).
This documentation site is in [`github.com/go-ruby-actionmailer/docs`](https://github.com/go-ruby-actionmailer/docs).
